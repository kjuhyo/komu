...
//   http://localhost:9999/komu/swagger-ui.html

   private String version = "V1";
   private String title = "Komu API " + version;
   ...
   public Docket api() {
      ...
      return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).groupName(version).select()
               .apis(RequestHandlerSelectors.basePackage("com.ssafy.kpop.controller"))
...
//      return regex("/admin/.*");
   ...
   private ApiInfo apiInfo() {
      return new ApiInfoBuilder().title(title)
            .description("<h3>Komu API Reference for Developers</h3><br>") 
            .version("1.0").build();
